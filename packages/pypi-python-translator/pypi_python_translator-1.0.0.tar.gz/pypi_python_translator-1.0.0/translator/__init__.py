...
def init(langg:str) -> any:
    ...
    inputlanguage = TRnslte(inputlanguage,langg)
    OutputLanguage = TRnslte(OutputLanguage,langg)
    texthere = TRnslte(texthere,langg)
    original = TRnslte(originalText,langg)
    os.system("cls")
