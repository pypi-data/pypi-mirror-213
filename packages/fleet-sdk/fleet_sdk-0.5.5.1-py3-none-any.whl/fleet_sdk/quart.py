...
from fleet_sdk.adapters.quart_adapter import QuartAdapter
    ...
    async def wrapper(*args, **kwargs):
      ...
      try:
        if isinstance(self.app, Quart):
          ...
          #Throw error
          print("Error: app is not a Quart app")
          raise Exception("Error: app is not a Quart app")
