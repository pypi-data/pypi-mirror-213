...
class PluginEntrypoint():
    ...
    def create_billing_events(self,session, event_request:Dict):
        ...
        for billing_event in events:
            ...
            event_query = f"""call SYSTEM$CREATE_BILLING_EVENT(
                    ...
                    '{str(billing_event.start_timestamp)}'::timestamp,
                    current_timestamp(),
    ...
    def network_addresses(self,method,connection_parameters:Dict,network_rule_name:str,oauth_secret_name:Optional[str],other_secrets_name:Optional[str]) -> List[str]:
        ...
        network_addresses_response = self._plugin_instance.network_addresses(ConnectionConfigurationParameters(connection_method=method,
                                                                connection_parameters=parse_obj_as(Dict[str,StoredConfigurationValue],connection_parameters),
        ...
        if len(network_addresses_response) > 0:
            ...
            for network_address in network_addresses_response:
        ...
        return network_addresses_response
