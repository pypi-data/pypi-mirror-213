...
class PanelItemPickerUI ( wx.Panel ):
    ...
    def __init__( self, parent, id = wx.ID_ANY, pos = wx.DefaultPosition, size = wx.Size( -1,-1 ), style = wx.TAB_TRAVERSAL, name = wx.EmptyString ):
        ...
        self.listBox_options = wx.ListBox( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, listBox_optionsChoices, wx.LB_EXTENDED, wx.DefaultValidator, u"optionsList" )
        ...
        self.listBox_selection = wx.ListBox( self, wx.ID_ANY, wx.DefaultPosition, wx.DefaultSize, listBox_selectionChoices, wx.LB_EXTENDED, wx.DefaultValidator, u"selectionList" )
