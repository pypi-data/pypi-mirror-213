...
TAB_INITIAL = {
    ...
    'Taxe de séjour ( seulement si réservation via Booking.com ) <-> addon' : names['name_taxe'],
    ...
    def format_allBookings(self,path_output = "./",table = TAB_INITIAL, names = names, to_drop = []):
        ...
        if(file_extension == ".xlsx"):
                ...
                try : 
                    ...
                    bookings.rename(columns = {'frais_menage':'frais_menage_'}, inplace = True)
                ...
                try : 
                    ...
                    bookings.rename(columns = {'taxe_sejour':'taxe_sejour_'}, inplace = True)
                ...
                try : 
                    ...
                    bookings.rename(columns = {'commission':'commission_'}, inplace = True)
                ...
                try : 
                    ...
                    bookings.rename(columns = {'frais_gestion':'frais_gestion_'}, inplace = True)
                ...
                try : 
                    ...
                    bookings.rename(columns = {'frais_electricite':'frais_electricite_'}, inplace = True)
                ...
                try : 
                    ...
                    bookings.rename(columns = {'frais_linge_serviettes':'frais_linge_serviettes_'}, inplace = True)
