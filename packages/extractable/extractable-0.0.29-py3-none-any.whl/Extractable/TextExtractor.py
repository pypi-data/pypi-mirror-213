...
class TesseractOCR(Pipe):
    ...
    def download_tesseract():
        ...
        # Download the file
        print('downloading Tesseract-OCR, please wait...')
    ...
    def process(dataobj: DataObj):
        ...
        # pytesseract.pytesseract.tesseract_cmd = r'C:\Program Files (x86)\Tesseract-OCR\tesseract.exe' #TODO: remove if solved
