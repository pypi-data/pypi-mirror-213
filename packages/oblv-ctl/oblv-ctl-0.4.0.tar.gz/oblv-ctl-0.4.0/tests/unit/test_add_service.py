...
from oblv_ctl.exceptions import HTTP_CLIENT_ERROR_MESSAGE, HTTP_CLIENT_ERROR_MESSAGE
...
class TestAddService(unittest.TestCase):
    ...
    def test_bad_request(self, sync):
        try:
            self.client.add_service(ref="master", repo_name="Repo_Name", repo_owner="Owner_Name")
            assert False
