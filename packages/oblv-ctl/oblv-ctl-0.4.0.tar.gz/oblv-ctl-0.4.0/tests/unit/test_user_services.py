...
from oblv_ctl.models.user_dynamic_service import UserDynamicService as UserServices
...
class TestUserServices(unittest.TestCase):
    ...
    def getSuccessResponse():
        res = Response(200, json={"total_pages": 1, "services": USER_SERVICES})
        return res
    ...
    def test_success_request(self, sync):
        ...
        self.assertEqual(self.client.user_services().services, obj)
