...
from oblv_ctl.models.service_yaml_content import ServiceYamlContent as ServiceContentResponse
...
class TestServiceYamlContent(unittest.TestCase):
    ...
    def test_bad_request(self, sync):
        try:
            self.client.service_content(repo_owner="Repo Owner", repo_name="Repo Name", ref="master")
            assert False
    ...
    def test_success_request(self, sync):
        ...
        self.assertEqual(self.client.service_content(repo_owner="Repo Owner", repo_name="Repo Name", ref="master"), obj)
