...
from register.models import Accomm, Attendee, ChildCare, Meal, Visa
...
class VisaExport(AttendeeAdminMixin, CSVExportView):
    ...
    columns = (
        ...
        'attendee.user.email',
        'country',
        'request_travel_bursary',
        'travel_bursary_status',
    )

    def request_travel_bursary(self, visa):
        try:
            return visa.attendee.user.bursary.request_travel
        except ObjectDoesNotExist:
            return False

    def travel_bursary_status(self, visa):
        try:
            return visa.attendee.user.bursary.travel_status
        except ObjectDoesNotExist:
            return ''
