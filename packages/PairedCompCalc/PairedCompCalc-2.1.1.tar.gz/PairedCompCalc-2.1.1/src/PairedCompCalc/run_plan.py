"""This script can help planning a paired-comparison experiment,
...
(p_true_pos, p_false_pos) = pcp.power_ab_mean(pcf, m_diff, q_std,
                                              ...
                                              n_pres=n_pres,
                                              n_sim=10)
# running two simulations for each round: one with m_diff and one with zero true difference

logger.info(f'RESULT: A paired-comparison experiment with {n_estim} subjects,' +
            f'\n\t\t using {n_difference_grades} difference grades, ' +
            f'forced_choice={pcf.forced_choice}, ' +
            f'{n_pres} pair presentations' +
