...
export class AuthManager {
    ...
    public async login() {
        ...
        if (registerClientResponseJsonData === undefined) {
    ...
    <p>
        ...
        <li>
            ...
            <a href={"https://docs.aws.amazon.com/codewhisperer/latest/userguide/what-is-cwspr.html"} className="cwspr-learn-more-link">
