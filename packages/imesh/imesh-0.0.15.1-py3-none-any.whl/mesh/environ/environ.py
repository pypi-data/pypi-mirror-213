...
class Environ:
    ...
    __mesh_min_channels = ['mesh.grpc.channel.rpc.min', 'mesh_grpc_channel_rpc_min', 'MESH_GRPC_CHANNEL_RPC_MIN']
    __mesh_max_channels = ['mesh.grpc.channel.rpc.max', 'mesh_grpc_channel_rpc_max', 'MESH_GRPC_CHANNEL_RPC_MAX']
    ...
    def get_arguments(self):
        ...
        parser.add_argument("--mesh.grpc.channel.rpc.min", type=int, default=3, required=False)
        parser.add_argument("--mesh.grpc.channel.rpc.max", type=int, default=3, required=False)
