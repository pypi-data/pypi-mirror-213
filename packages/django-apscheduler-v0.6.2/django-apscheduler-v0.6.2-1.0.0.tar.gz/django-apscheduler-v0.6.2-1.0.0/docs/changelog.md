...
- change model DjangoJob delete mode to logic delete (Resolves [#165](https://github.com/jcass77/django-apscheduler/issues/165)).

The related modification only for their own project use, if there is infringement, please contact to delete.
