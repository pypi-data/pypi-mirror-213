...
class TQDataSet(DataSet): 
    ...
    d0001=Column(float) #單月營收_千元
    d0002=Column(float) #去年單月營收_千元
    d0003=Column(float) #單月營收成長率％
    d0004=Column(float) #單月營收與上月比％
    d0005=Column(float) #累計營收_千元
    d0006=Column(float) #去年累計營收_千元
    d0007=Column(float) #累計營收成長率％
    a4maxh=Column(float) #歷史最高單月營收_千元
    a4maxd=Column(float) #歷史最高單月營收_年月
    a4max_pct=Column(float) #與歷史最高單月營收比%
    a4minh=Column(float) #歷史最低單月營收_千元
    a4mind=Column(float) #歷史最低單月營收_年月
    a4min_pct=Column(float) #與歷史最低單月營收比%
    sl_month=Column(float) #創 N月新高/低
    t8107=Column(float) #近12月累計營收_千元
    t8111=Column(float) #去年近12月累計營收_千元
    r18=Column(float) #近12月累計營收成長率％
    t8133=Column(float) #近 3月累計營收_千元
    t8134=Column(float) #去年近 3月累計營收_千元
    r25=Column(float) #近3月累計營收成長率％
    r26=Column(float) #近3月累計營收與上月比％
    r26a=Column(float) #近3月累計營收變動率％
    d0025=Column(float) #流通在外股數_千股
    d0026=Column(float) #單月每股營收_元
    d0027=Column(float) #累計每股營收_元
    r19=Column(float) #近12月每股營收_元
    r27=Column(float) #近 3月每股營收_元
    
    Qfii_Buy_Vol=Column(float) #外資買進張數
    Qfii_Sell_Vol=Column(float) #外資賣出張數
    Qfii_Diff__Vol=Column(float) #外資買賣超張數
    Qfii_Buy_Amt=Column(float) #外資買進金額_元
    Qfii_Sell_Amt=Column(float) #外資賣出金額_元
    Qfii_Diff__Amt=Column(float) #外資買賣超金額_元
    Qfii_Stock_Holding_Pct=Column(float) #外資持股率
    Fund_Buy_Vol=Column(float) #投信買進張數
    Fund_Sell_Vol=Column(float) #投信賣出張數
    Fund_Diff__Vol=Column(float) #投信買賣超張數
    Fund_Buy_Amt=Column(float) #投信買進金額_元
    Fund_Sell_Amt=Column(float) #投信賣出金額_元
    Fund_Diff__Amt=Column(float) #投信買賣超金額_元
    ...
    Margin_Balance_Raio=Column(float) #資券比
    ...
    Total_Assets_Growth_Rate = Column(float) #資產   
    ...
    Total_Operating_Income = Column(float) 
    Net_Income_Growth_Rate = Column(float) 
