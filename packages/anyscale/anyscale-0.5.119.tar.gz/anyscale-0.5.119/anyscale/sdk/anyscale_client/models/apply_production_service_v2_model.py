...
class ApplyProductionServiceV2Model(object):
    ...
    def __init__(self, name=None, description=None, project_id=None, version=None, canary_percent=None, ray_serve_config=None, build_id=None, compute_config_id=None, rollout_strategy=None, ray_gcs_external_storage_config=None, local_vars_configuration=None):  # noqa: E501
