...
from pyaioredis.client import Redis
from pyaioredis.connection import Connection, ConnectionPool, EncodableT, SSLConnection
...
from pyaioredis.utils import str_if_bytes
...
class Sentinel:
    ...
    >>> from pyaioredis.sentinel import Sentinel
