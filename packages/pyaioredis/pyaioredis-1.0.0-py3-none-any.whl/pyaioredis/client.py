...
from pyaioredis.compat import Protocol, TypedDict
...
from pyaioredis.lock import Lock
from pyaioredis.utils import safe_str, str_if_bytes
...
class PubSub:
    ...
    HEALTH_CHECK_MESSAGE = "pyaioredis-py-health-check"
