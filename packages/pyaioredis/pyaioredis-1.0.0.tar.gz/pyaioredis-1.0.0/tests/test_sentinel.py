...
import pyaioredis.sentinel
from pyaioredis import exceptions
from pyaioredis.sentinel import (
    MasterNotFoundError,
    Sentinel,
...
async def cluster(master_ip):
    ...
    saved_Redis = pyaioredis.sentinel.Redis
    pyaioredis.sentinel.Redis = cluster.client
    yield cluster
    pyaioredis.sentinel.Redis = saved_Redis
