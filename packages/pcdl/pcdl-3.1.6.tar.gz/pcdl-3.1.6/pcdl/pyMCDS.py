...
# definition cathegorical numerical
es_numerical = {
    'attachment_elastic_constant',  # real
    'attachment_rate',  # real
    'attack_rates',  # real plural 0,1,2
    'calcification_rate',  # real
    'calcified_fraction',  # real
    'cell_BM_adhesion_strength',  # real
    'cell_BM_repulsion_strength',  # real
    'cell_adhesion_affinities',  # real plural 0,1,2
    'cell_cell_adhesion_strength',  # real
    'cell_cell_repulsion_strength',  # real
    'cell_count_voxel',  # integer
    'cell_density_micron3',  # real
    'chemotactic_sensitivities',  # real plural a,b,c
    #'chemotaxis_index',  # integer ???
    'current_cycle_phase_exit_rate',  # real
    'cytoplasmic_biomass_change_rate',  # real
    'cytoplasmic_volume',  # real
    #'damage',  # ???
    'damage_rate',  # real
    'dead_phagocytosis_rate',  # real
    'death_rates_0',  # real apoptosis!
    'death_rates_1',  # real necrosis!
    'detachment_rate',  # real
    'elapsed_time_in_phase',  # real
    'fluid_change_rate',  # real
    'fluid_fraction',  # real
    'fraction_released_at_death',  # real plural a,b,c
    'fraction_transferred_when_ingested',  # real plural a,b,c
    'fusion_rates',  # real plural 0,1,2
    'internalized_total_substrates',  # real plural a,b,c
    'live_phagocytosis_rates',  # real plural 0,1,2
    'maximum_number_of_attachments',  # integer  (12)
    'mesh_center_m',  # real
    'mesh_center_n',  # real
    'mesh_center_p',  # real
    'migration_bias',  # real
    'migration_bias_direction_x',  # real
    'migration_bias_direction_y',  # real
    'migration_bias_direction_z',  # real
    'migration_speed',  # real
    'motility_vector_x',  # real
    'motility_vector_y',  # real
    'motility_vector_z',  # real
    'net_export_rates',  # real plural a,b,c
    'nuclear_biomass_change_rate',  # real
    'nuclear_radius',  # real
    'nuclear_volume',  # real
    'number_of_nuclei',  # integer
    'orientation_x',  # real
    'orientation_y',  # real
    'orientation_z',  # real
    #'oxygen',
    ...
    'pressure',  # real
    'radius',  # real
    'relative_maximum_adhesion_distance',  # real
    'saturation_densities',  # real plural a,b,c
    'secretion_rates',  # real plural a,b,c
    'surface_area',  # real
    'target_fluid_fraction',  # real
    'target_solid_cytoplasmic',  # real
    'target_solid_nuclear',  # real
    'total_attack_time',  # real
    'total_volume',  # real
    'transformation_rates',  # real plural 0,1,2
    'uptake_rates',  # real plural a,b,c
    'velocity_x',  # real
    'velocity_y',  # real
    'velocity_z',  # real
    'voxel_i',  # integer
...
# bue: for velocity, motility (?), orientation (?), one could maybe calculate a total force vector?

# unsure
    'chemotaxis_direction',  # boolean ???
    'chemotaxis_index',  # integer ???
    'damage',  # ???
    'polarity',  # ???
...
es_categorical = {
    ...
    'current_death_model',  # cathegorical
    'current_phase',  # cathegorical evt ordered?
    'cycle_model',  # cathegorical
}

es_boolean = {
    'contact_with_basement_membrane',  # boolean
    'dead',  # boolean
    'is_motile',  # boolean
}
