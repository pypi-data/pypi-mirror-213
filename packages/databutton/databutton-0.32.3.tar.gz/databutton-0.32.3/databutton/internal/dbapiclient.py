...
def get_dbapi_client() -> httpx.Client:
    ...
    """
    # TODO: Introduce a DATABUTTON_COMPONENT_ID env var to
    #  figure out if we're called from app or job or perhaps locally?
    headers = {
        "X-DATABUTTON-RELEASE": os.environ.get("DATABUTTON_RELEASE", "dev"),
        "X-DATABUTTON-DEVX-VERSION": os.environ.get("DEVX_VERSION", "no-devx"),
        "X-DATABUTTON-SDK-VERSION": version.__version__ or "dev",
    }
    return httpx.Client(
