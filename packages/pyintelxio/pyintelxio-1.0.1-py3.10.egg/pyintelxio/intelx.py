...
class IntelXService(intelx):
    ...
    def get_storage_data(self, sid, bucket, media):
        return self.FILE_VIEW(0, media, sid, bucket) 
    
    def get_storage_preview(self, sid, bucket, ctype, media):
        return self.FILE_PREVIEW(ctype, media, 0, sid, bucket, 1, 12) 
    
    def get_capabilities(self):
        return self.GET_CAPABILITIES()
    
    def download_file(self, sid, bucket, type=0):
