...
class ClientMainWindow(QMainWindow):
    """
    Класс, реализующий основное окно пользователя.
    ...
    def select_active_user(self):
        """Метод обработчик события двойного клика по списку клиентов"""
    ...
    def add_contact(self, new_contact):
        """
        Метод, добавляющий контакт в серверную и клиентскую базы данных.
        После обновления баз данных обновляет содержимое окна.
        """
        try:
    ...
    def message(self, message_dict):
        ...
        encrypted_message = base64.b64decode(message_dict['message'])
        ...
        self.database.save_message(message_dict['from'], 'in', decrypted_message.decode('utf8'))
