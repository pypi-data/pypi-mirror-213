...
class SimplePredicate(Predicate):
    ...
    def __init__(self, func: PredicateFunction, field: str):
        ...
        self.exc_order_bword = False  # exclusion order between word
        self.exc_space = False  # exclusion space
        self.exc_spec_char = False  # exclusion special character
        self.exc_without_accent = False  # exclusion VietNam without accent
