...
def main(argv):
    ...
    setuptools.setup(
        ...
        keywords = """Python""",
        url = 'https://github.com/ameli/tracera',
        download_url = 'https://github.com/ameli/tracera/archive/master.zip',
        project_urls = {
            "Documentation": "https://github.com/ameli/tracera/blob/master/README.rst",
            "Source": "https://github.com/ameli/tracera",
            "Tracker": "https://github.com/ameli/tracera/issues",
        },
