...
class Session(_message.Message):
    __slots__ = ["address", "bandwidth", "duration", "id", "node_address", "status", "status_at", "subscription_id"]
