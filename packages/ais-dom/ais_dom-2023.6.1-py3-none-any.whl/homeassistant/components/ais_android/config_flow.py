        ...
        if user_input is not None:
            ...
            if device_calss == "ais":
                ...
                if host == "127.0.0.1" and ais_global.has_root():
                    ...
                    await self.async_execute_command(
                        "su -c 'cat /data/data/com.termux/files/home/AIS/.storage/androidtv_adbkey.pub >> "
                        "/data/misc/adb/adb_keys'"
                    )
                    # TODO add without rm
                    # await self.async_execute_command(
                    #     "su -c 'grep  -F -f /data/data/com.termux/files/home/AIS"
                    #     "/.storage/androidtv_adbkey.pub /data/misc/adb/adb_keys || cat "
                    #     "/data/data/com.termux/files/home/AIS/.storage"
