...
def train_one_epoch(model, optimizer, data_loader, device,
                    epoch, print_freq,
                    lr_scheduler=None, scaler=None) -> MetricLogger:
    """Perform one training epoch over the
    data loader using the specified optimizer and learning rate
    scheduler
