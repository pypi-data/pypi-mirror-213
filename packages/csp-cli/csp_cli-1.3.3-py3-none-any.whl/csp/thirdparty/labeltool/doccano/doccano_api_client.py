...
class DoccanoClient(_Router):
    ...
    #     use_relation_labeling:bool = True,
    # ) -> requests.models.Response:
    ...
    #         "use_relation_labeling":use_relation_labeling,
    #     }
    ...
    "updated_at": "2022-07-12T06:07:17.834994Z",
    "random_order": false,
    "created_by": 1,
    ...
    def create_project(
        ...
        is_text_project: bool = True,
        can_define_label: bool = True,
        can_define_relation: bool = False,
        can_define_category: bool = False,
        can_define_span: bool = True,
        ...
        payload = {
            ...
            "guideline": guideline,
            "resourcetype": resourcetype,
            "random_order": randomize_document_order,
            "collaborative_annotation": collaborative_annotation,
            "single_class_classification":single_class_classification,
            "is_text_project":is_text_project,
            "can_define_label":can_define_label,
            "can_define_relation": can_define_relation,
            "can_define_category": can_define_category,
            "can_define_span": can_define_span, 
    ...
    def get_doc_download(
        self, project_id: int, file_format: str = "JSONL", only_approved: bool = False
    ) -> requests.models.Response:
        """Downloads the dataset in specified format.
        Args:
            project_id (int): The project id.
        ...
        Returns:
            requests.models.Response: The request response.
        """   
        result = self.post(f'v1/projects/{project_id}/download', json={'exportApproved': only_approved, 'format': file_format}) 
        task_id = result['task_id']
        while True:
            result = self.get(f'v1/tasks/status/{task_id}')
            if result['ready']:
                break
            time.sleep(1)
        result = self.get_file(f'v1/projects/{project_id}/download?taskId={task_id}')
