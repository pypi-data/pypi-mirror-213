...
class CRNN(object):
    def __init__(self, **kwargs) -> None:
        cfg = dict(
            ...
            input_names=kwargs.get("input_names", ["INPUT__0"]),
            output_names=kwargs.get("output_names", ["OUTPUT__0", "OUTPUT__1"]),
            thread_safe=kwargs.get("thread_safe", False),
        )
        self._model = _libc.crnn_init(conlib.dumps(cfg).encode())   
    ...
    def run(self, img):
        ...
        _outputs = (CTENSOR * len(self.output_names))()
