...
#define trace0(args)                        \
    {                                       \
        if (qh->IStracing) qh_fprintf args; \
    }
#define trace1(args)                             \
    {                                            \
        if (qh->IStracing >= 1) qh_fprintf args; \
    }
#define trace2(args)                             \
    {                                            \
        if (qh->IStracing >= 2) qh_fprintf args; \
    }
#define trace3(args)                             \
    {                                            \
        if (qh->IStracing >= 3) qh_fprintf args; \
    }
#define trace4(args)                             \
    {                                            \
        if (qh->IStracing >= 4) qh_fprintf args; \
    }
#define trace5(args)                             \
    {                                            \
        if (qh->IStracing >= 5) qh_fprintf args; \
    }
#else /* qh_NOtrace */
#define trace0(args) \
    {}
