...
# Turbocharger.setturmapavi("LPT01.MAP",1,1,1,1)


# T=Turbocharger.gasturb2turmap("LPT01.MAP")
# T.table[0]*=1
...
# T=Table.ArrayTable().init("Turbine_35.csv")

map=Turbocharger.Turbine.TurbineMap("Turbine_hr40.csv").init(T,2e5,500,1)
...
for i in spe:
    t=map.getline(i)
    plt.plot(t.table[2].data,t.table[1].data)
    plt.pause(0.1)
