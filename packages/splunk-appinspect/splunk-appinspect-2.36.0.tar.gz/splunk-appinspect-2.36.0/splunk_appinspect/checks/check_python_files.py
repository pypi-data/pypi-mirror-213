        ...
        for directory, file, _ in py_files:
            ...
            for lineno, result in match_result:
                ...
                try:
                    ...
                    reporter_output = ("Issue parsing version found in for the python httplib2"
                ...
                if parsed_ver < min_ver:
                    ...
                    reporter_output = ("Detected an outdated version of the Python httplib2"
