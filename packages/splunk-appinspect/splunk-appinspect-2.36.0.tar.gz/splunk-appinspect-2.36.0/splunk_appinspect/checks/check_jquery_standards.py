...
@splunk_appinspect.tags("cloud", "jquery", "private_app", "private_victoria", "migration_victoria", "private_classic")
...
def check_hotlinking_splunk_web_libraries(app, reporter):
    ...
    html_static_template_files = list(
        app.get_filepaths_of_files(basedir="appserver/static/template", types=[".html"])
    )
    unpacked_html_static_template_files = util.unpack_absolute_path(html_static_template_files)
    unpacked_html_files = unpacked_html_dashboard_files + unpacked_html_template_files + unpacked_html_static_template_files
...
@splunk_appinspect.tags("cloud", "future", "jquery", "private_app", "private_victoria", "migration_victoria", "private_classic")
@splunk_appinspect.cert_version(min="2.5.0")
