...
class AbstractDiveplaneClient(ABC):
    """The base definition of the Diveplane client interface."""
    ...
    def get_trainee(self, trainee_id):
        """Get an existing trainee from the Diveplane service."""
    ...
    def delete_trainee(self, trainee_id):
        """Delete a trainee in the Diveplane service."""
    ...
    def copy_trainee(
        ...
        """Copy a trainee in the Diveplane service."""
    ...
    def persist_trainee(self, trainee_id):
        """Persist a trainee in the Diveplane service."""
