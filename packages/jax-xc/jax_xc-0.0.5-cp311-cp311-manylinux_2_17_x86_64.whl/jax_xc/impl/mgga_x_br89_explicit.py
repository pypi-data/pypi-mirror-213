...
def pol(p, r, s=(None, None, None), l=(None, None), tau=(None, None)):
  ...
  t48 = jnp.abs(t47)
  t51 = jnp.where(0. < t47, 0.5e-12, -0.5e-12)
  ...
  t147 = jnp.abs(t146)
  t150 = jnp.where(0. < t146, 0.5e-12, -0.5e-12)
...
def unpol(p, r, s=None, l=None, tau=None):
  ...
  t44 = jnp.abs(t43)
  t47 = jnp.where(0. < t43, 0.5e-12, -0.5e-12)
