...
def pol(p, r, s=(None, None, None), l=(None, None), tau=(None, None)):
  ...
  t112 = jnp.where(r0 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t26 * t27 * (t91 + t107))
  t114 = jnp.where(t10, t15, -t17)
  t115 = jnp.where(t14, t11, t114)
  t116 = t115 + 0.1e1
  t118 = jnp.cbrt(t116)
  t120 = jnp.where(t116 <= p.zeta_threshold, t23, t118 * t116)
  t122 = r1 ** 2
  t123 = jnp.cbrt(r1)
  t124 = t123 ** 2
  t127 = s2 / t124 / t122
  ...
  t199 = jnp.where(r1 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t120 * t27 * (t167 + t194))
  res = t112 + t199
  return res
...
def unpol(p, r, s=None, l=None, tau=None):
  ...
  t108 = jnp.where(r0 / 0.2e1 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t3 / t4 * t18 * t19 * (t87 + t103))
  res = 0.2e1 * t108
  return res
