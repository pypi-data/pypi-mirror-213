...
def pol(p, r, s=(None, None, None), l=(None, None), tau=(None, None)):
  ...
  t209 = jnp.where(t137, 0.27, t83)
  t210 = t209 ** 2
  t212 = t210 ** 2
  t213 = 0.64e2 * t212
  t217 = jnp.exp(-0.1e1 / t210 / 0.4e1)
  t223 = jax.lax.erf(0.1e1 / t209 / 0.2e1)
  t230 = jnp.where(0.27 <= t83, t174 + t207, 0.1e1 + 0.24e2 * t210 * ((0.2e2 * t210 - t213) * t217 - 0.3e1 - 0.36e2 * t210 + t213 + 0.1e2 * t209 * t113 * t223))
  t236 = 0.43662396e-1 * t52 * t41
  t240 = t133 ** 2
  t241 = 0.1e1 / t240
  t246 = 0.32 < t83
  t247 = jnp.where(t246, t83, 0.32)
  t248 = t247 ** 2
  t249 = t248 ** 2
  t252 = t249 * t248
  t255 = t249 ** 2
  ...
  t341 = jnp.where(0.32 <= t83, t303, 0.1e1 + 0.8e1 / 0.7e1 * t304 * ((-0.576e3 * t309 * t304 - 0.12288e6 * t314 * t304 + 0.384e4 * t309 * t307 - 0.8e1 * t304 + 0.256e3 * t307) * t320 + 0.24e2 * t307 * (0.512e4 * t309 * t306 + 0.224e3 * t306 - 0.144e4 * t309 - 0.35e2) + 0.2e1 * t113 * (-0.2e1 + 0.6e2 * t306) * t334))
  t351 = jnp.where(r0 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t26 * t27 * (t132 / t133 + 0.35e2 / 0.81e2 * t230 * (-0.14554132 * tau0 / t46 / r0 + t236 + 0.42296278333333333333e-1 * t49) * t43 * t241 + 0.26329605555555555556e-1 * t341 * t38 * t42 * t49 * t241))
  ...
  t517 = jnp.where(t445, 0.27, t392)
  t518 = t517 ** 2
  t520 = t518 ** 2
  t521 = 0.64e2 * t520
  t525 = jnp.exp(-0.1e1 / t518 / 0.4e1)
  t531 = jax.lax.erf(0.1e1 / t517 / 0.2e1)
  t538 = jnp.where(0.27 <= t392, t482 + t515, 0.1e1 + 0.24e2 * t518 * ((0.2e2 * t518 - t521) * t525 - 0.3e1 - 0.36e2 * t518 + t521 + 0.1e2 * t517 * t113 * t531))
  t546 = t441 ** 2
  t547 = 0.1e1 / t546
  t552 = 0.32 < t392
  t553 = jnp.where(t552, t392, 0.32)
  t554 = t553 ** 2
  t555 = t554 ** 2
  t558 = t555 * t554
  t561 = t555 ** 2
  ...
  t647 = jnp.where(0.32 <= t392, t609, 0.1e1 + 0.8e1 / 0.7e1 * t610 * ((-0.576e3 * t615 * t610 - 0.12288e6 * t620 * t610 + 0.384e4 * t615 * t613 - 0.8e1 * t610 + 0.256e3 * t613) * t626 + 0.24e2 * t613 * (0.512e4 * t615 * t612 + 0.224e3 * t612 - 0.144e4 * t615 - 0.35e2) + 0.2e1 * t113 * (-0.2e1 + 0.6e2 * t612) * t640))
  t657 = jnp.where(r1 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t5 * t359 * t27 * (t440 / t441 + 0.35e2 / 0.81e2 * t538 * (-0.14554132 * tau1 / t363 / r1 + t236 + 0.42296278333333333333e-1 * t366) * t43 * t547 + 0.26329605555555555556e-1 * t647 * t38 * t42 * t366 * t547))
  res = t351 + t657
  return res
...
def unpol(p, r, s=None, l=None, tau=None):
  ...
  t195 = jnp.where(t123, 0.27, t69)
  t196 = t195 ** 2
  t198 = t196 ** 2
  t199 = 0.64e2 * t198
  t203 = jnp.exp(-0.1e1 / t196 / 0.4e1)
  t209 = jax.lax.erf(0.1e1 / t195 / 0.2e1)
  t216 = jnp.where(0.27 <= t69, t160 + t193, 0.1e1 + 0.24e2 * t196 * ((0.2e2 * t196 - t199) * t203 - 0.3e1 - 0.36e2 * t196 + t199 + 0.1e2 * t195 * t99 * t209))
  t227 = t119 ** 2
  t228 = 0.1e1 / t227
  t233 = 0.32 < t69
  t234 = jnp.where(t233, t69, 0.32)
  t235 = t234 ** 2
  t236 = t235 ** 2
  t239 = t236 * t235
  t242 = t236 ** 2
  ...
  t328 = jnp.where(0.32 <= t69, t290, 0.1e1 + 0.8e1 / 0.7e1 * t291 * ((-0.576e3 * t296 * t291 - 0.12288e6 * t301 * t291 + 0.384e4 * t296 * t294 - 0.8e1 * t291 + 0.256e3 * t294) * t307 + 0.24e2 * t294 * (0.512e4 * t296 * t293 + 0.224e3 * t293 - 0.144e4 * t296 - 0.35e2) + 0.2e1 * t99 * (-0.2e1 + 0.6e2 * t293) * t321))
  t339 = jnp.where(r0 / 0.2e1 <= p.dens_threshold, 0, -0.3e1 / 0.8e1 * t3 / t4 * t18 * t19 * (t118 / t119 + 0.35e2 / 0.81e2 * t216 * (-0.14554132 * tau0 * t37 / t40 / r0 + 0.43662396e-1 * t46 * t33 + 0.42296278333333333333e-1 * t43) * t35 * t228 + 0.26329605555555555556e-1 * t328 * t30 * t34 * t38 * t42 * t228))
  res = 0.2e1 * t339
  return res
