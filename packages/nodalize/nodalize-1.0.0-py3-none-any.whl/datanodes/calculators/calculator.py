...
class Calculator(ABC, Generic[T]):
    ...
    def join_data_frames(
        self, left: T, right: T, how: str, on: List[Tuple[str, str]]
    ) -> T:
        """
        Join 2 data frames.
    ...
    @abstractmethod
    def has_duplicates(self, key_columns: List[str], dataframe: T) -> bool:
        """
    ...
    @abstractmethod
    def has_nulls(self, column_names: List[str], dataframe: T) -> bool:
        """
