...
class DateDependency(DependencyDefinition):
    ...
    def __init__(
        ...
        *,
        ...
        self._date_column = None  # type: Optional[str]
            ...
            if len(filters) == 1:
                ...
                filters[0].extend(
                    [
                        ...
                        if k in parameter_columns and k != self.data_node.date_column
                    ]
                )
