...
class Tag(object):
    ...
    def __init__(self, id=None, name=None, files=None, file_count=None, items=None, color='#329db6', comments=None, create_time=None):  # noqa: E501
    ...
    @property
    def items(self):
        """Gets the items of this Tag.  # noqa: E501


        :return: The items of this Tag.  # noqa: E501
        :rtype: list[TaggedItem]
        """
        return self._items
    ...
    def items(self, items):
        ...
        :param items: The items of this Tag.  # noqa: E501
        :type: list[TaggedItem]
        """
