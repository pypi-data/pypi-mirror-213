...
import mock
import pytest
from lumaconf import (ConfigFactory, ConfigParser, ConfigSubstitutionException, ConfigTree, HOCONConverter)
...
class TestConfigParser(object):
    ...
    def test_resolve_package_path(self):
        path = ConfigParser.resolve_package_path("lumaconf:config_parser.py")
        assert os.path.exists(path)

    def test_resolve_package_path_format(self):
        with pytest.raises(ValueError):
            ConfigParser.resolve_package_path("lumaconf/config_parser.py")
