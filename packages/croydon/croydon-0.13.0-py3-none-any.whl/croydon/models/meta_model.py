...
from typing import Optional, Iterable, Type, TYPE_CHECKING
...
class MetaModel:
    ...
    # every write to _computed_fields is preceded by copying, so it's
    # all right to have a mutable initializer here
    _computed_fields: dict[str, ComputedField] = {}
