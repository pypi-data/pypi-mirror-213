...
class ReferenceField(ObjectIdField, Generic[TModelType]):
    ...
    def __init__(
        ...
        *,
        ...
        unique: bool = False,
        on_destroy: ReferenceOnDestroy = ReferenceOnDestroy.RAISE,
    ) -> None:
        super().__init__(
            required=required,
            rejected=rejected,
