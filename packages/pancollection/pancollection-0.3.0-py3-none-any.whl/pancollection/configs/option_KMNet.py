...
class parser_args(TaskDispatcher, name='KMNet'):
    def __init__(self, cfg=None):
        ...
        parser.add_argument('--samples_per_gpu', default=2, type=int,  # 8
        ...
        ##
        parser.add_argument('--arch', '-a', metavar='ARCH', default='KMNet', type=str)
