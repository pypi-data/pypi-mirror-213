...
class CustomModel(azureml_mlflow.aml.AzureMLModel):
    def __init__(self):
        pass
...
"""
    ...
    with azureml_mlflow.start_run():
        model_info1 = azureml_mlflow.aml.log_model(
            artifact_path="model1",
            aml_model=custom_model,
            code_path=[str(mod1)],
        )
        model_info2 = azureml_mlflow.aml.log_model(
    ...
    loaded_model1 = azureml_mlflow.aml.load_model(model_info1.model_uri, model_type="classifier")
    assert loaded_model1.predict(model_input) == 1
    loaded_model2 = azureml_mlflow.aml.load_model(model_info2.model_uri, model_type="classifier")
