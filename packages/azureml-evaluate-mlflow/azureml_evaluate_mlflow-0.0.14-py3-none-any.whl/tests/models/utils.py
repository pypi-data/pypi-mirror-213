...
def newsgroup_dataset():
    ...
    constructor_args = {"data": data[:20], "targets": 'y', "name": "newsgroup_dataset"}
    ds = EvaluationDataset(**constructor_args)
    ds._constructor_args = constructor_args
    return ds
...
def newsgroup_dataset_text_pair():
    ...
    constructor_args = {"data": data[:20], "targets": 'y', "name": "newsgroup_dataset_text_pair"}
    ds = EvaluationDataset(**constructor_args)
    ds._constructor_args = constructor_args
    return ds
...
def billsum_dataset():
    ...
    for i in range(len(test_dataset["article"])):
        ...
        summaries.append(test_dataset["abstract"][i])
