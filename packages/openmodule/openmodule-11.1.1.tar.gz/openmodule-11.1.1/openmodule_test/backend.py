...
class BackendTestMixin(OpenModuleCoreTestMixin):
    ...
    * set the backend_class
    ...
    def create_count_message(self, transaction_id=None, *, resource="arivotest", user="api-backend_user", gate="gate1",
                             ...
                             category="permanent-employee", correction=False, error=None, entry_timestamp=None,
                             **kwargs):
        ...
        :param entry_timestamp: Timestamp of the entry count message. Only available for valid outgoing movements.
        ...
        if entry_timestamp is not None:
            data.update(start=entry_timestamp)
