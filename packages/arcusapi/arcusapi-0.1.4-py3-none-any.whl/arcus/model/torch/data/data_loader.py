...
class VerticallyAugmentedDataLoader(DataLoader):
    ...
    Args:
        ...
        loader_split_type: The split of dataloader to fetch external data for.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.loader_split_type = loader_split_type
        ...
        if isinstance(existing_dataset, VerticallyAugmentedDataset):
            ...
            dataset = VerticallyAugmentedDataset(existing_dataset)
    ...
    def get_loader_split_type(self) -> SplitType:
        return self.loader_split_type
...
def wrap_dataloader_vertical(
    ...
    loader_split_type: Optional[SplitType] = None,
    join_tensor_index: int = 0,
) -> VerticallyAugmentedDataLoader:
    """
    ...
    """
    if (
        external_data_client is None
        or loader_split_type is None
        or isinstance(dataloader, VerticallyAugmentedDataLoader)
    ):
        return dataloader
