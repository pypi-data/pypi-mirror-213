...
class AppSettings(BaseSettings):
    ...
    # Firebase config
    FIRESTORE_COLLECTION_NAME: str = "service_account"
    FIRESTORE_PROJECT_ID: str = os.getenv("FIRESTORE_PROJECT_ID", "")
    FIRESTORE_PRIVATE_KEY_ID: str = os.getenv("FIRESTORE_PRIVATE_KEY_ID", "")
    FIRESTORE_PRIVATE_KEY: str = os.getenv("FIRESTORE_PRIVATE_KEY", "").replace(r'\n', '\n')
    FIRESTORE_CLIENT_EMAIL: str = os.getenv("FIRESTORE_CLIENT_EMAIL", "")
    FIRESTORE_CLIENT_ID: str = os.getenv("FIRESTORE_CLIENT_ID", "")
    FIRESTORE_AUTH_URI: str = "https://accounts.google.com/o/oauth2/auth"
    FIRESTORE_TOKEN_URI: str = "https://oauth2.googleapis.com/token"
    FIRESTORE_AUTH_PROVIDER_X509_CERT_URL: str = "https://oauth2.googleapis.com/token"
