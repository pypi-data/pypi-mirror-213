...
class AppSettings(BaseSettings):
    ...
    FIRESTORE_CLIENT_ID: str = ""
    FIRESTORE_AUTH_URI: str = ""
    FIRESTORE_TOKEN_URI: str = ""
    FIRESTORE_AUTH_PROVIDER_X509_CERT_URL: str = ""
    FIRESTORE_CLIENT_X509_CERT_URL: str = ""
