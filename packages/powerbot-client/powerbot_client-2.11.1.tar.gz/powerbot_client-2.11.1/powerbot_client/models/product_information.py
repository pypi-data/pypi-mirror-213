...
class ProductInformation(object):
    ...
    def __init__(self, product_name=None, delivery_area=None, price_currency=None, quantity_unit=None, duration_minutes=None, local_vars_configuration=None):  # noqa: E501
