...
class SignalEntry(object):
    ...
    def time_slices(self):
        ...
        The list of time slice entries. Note that only 100 time slices can be posted at once, while the total amount stored in the system is 100. Any request exceeding this limit will result in an error response.  # noqa: E501
