...
class TimeSliceEntry(object):
    ...
    def parameters(self):
        ...
        The content of the signal, posted as key/value pairs. Position long and short values have to be written in lower and snake case for the signal to be considered a position one and you may also have a other attributes alongside it. Unlike with the existing signals, where position signals always had 'POSITION' as its source, all signals (custom/position valued) will have the source sent as its source.  # noqa: E501
