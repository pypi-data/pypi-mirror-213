...
class ReportApi(object):
    ...
    def get_schedule_xml(self, delivery_area, delivery_day, member_eic, exchange_eic, receiver_eic, process_type, sender_role, receiver_role, **kwargs):  # noqa: E501
        """Create ESS Schedule XML  # noqa: E501

        Create a delivery area internal ESS schedule XML file for the nomination toward the TSO. The file is based on ESS version 2.3 and only includes the schedule between the exchange member and the member. The revision will be increased with every request performed. You need to provide the EIC of the exchange member as well as the EIC of the exchange.  For a detailed documentation and example values for different countries, please refer to the [Knowledge Base](https://docs.powerbot-trading.com/docs/features/ess-schedule/).  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
