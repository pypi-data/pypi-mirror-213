...
# body param
SchemaForRequestBodyApplicationJson = SaveReferrerDTO


request_body_save_referrer_dto = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_user_referrer_oapg(
        self,
    ...
    def _create_user_referrer_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_save_referrer_dto.serialize(body, content_type)
...
class CreateUserReferrer(BaseApi):
    ...
    def create_user_referrer(
        ...
        return self._create_user_referrer_oapg(
            body=body,
