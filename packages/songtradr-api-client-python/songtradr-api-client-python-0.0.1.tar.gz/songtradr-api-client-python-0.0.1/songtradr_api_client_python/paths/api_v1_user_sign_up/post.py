...
# body param
SchemaForRequestBodyApplicationJson = SaveUserDTO


request_body_save_user_dto = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = SignUpDTO
...
class BaseApi(api_client.Api):
    ...
    def _sign_up_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_save_user_dto.serialize(body, content_type)
