...
request_path_songtradr_playlist_guid = api_client.PathParameter(
...
SchemaFor200ResponseBodyApplicationHaljson = schemas.DictSchema
...
class BaseApi(api_client.Api):
    ...
    def _delete_playlist_oapg(
        ...
        _path_params = {}
        for parameter in (
            request_path_songtradr_playlist_guid,
        ):
