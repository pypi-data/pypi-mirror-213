...
# body param
SchemaForRequestBodyApplicationJson = UpdatePasswordDTO


request_body_update_password_dto = api_client.RequestBody(
    content={
...
SchemaFor204ResponseBodyApplicationHaljson = schemas.DictSchema
...
class ApiResponseFor204(api_client.ApiResponse):
    ...
    body: typing.Union[
        SchemaFor204ResponseBodyApplicationHaljson,
    ]
...
_response_for_204 = api_client.OpenApiResponse(
    ...
    content={
        'application/hal+json': api_client.MediaType(
            schema=SchemaFor204ResponseBodyApplicationHaljson),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _update_password_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_update_password_dto.serialize(body, content_type)
