...
class SaveRecordingGenreDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["genreName", "genreType", "affinity", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["genreName", "genreType", "affinity", ], str]):
