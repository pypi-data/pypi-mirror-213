...
class FileUploadDTO(
        ...
        class properties:
            ...
            class identifiers(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ConfigIdentifierDTO']:
                        return ConfigIdentifierDTO
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ConfigIdentifierDTO'], typing.List['ConfigIdentifierDTO']],
                ...
                def __getitem__(self, i: int) -> 'ConfigIdentifierDTO':
            ...
            class access(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ConfigAccessDTO']:
                        return ConfigAccessDTO
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ConfigAccessDTO'], typing.List['ConfigAccessDTO']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'access':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'ConfigAccessDTO':
                    return super().__getitem__(i)
            __annotations__ = {
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["identifiers", "flags", "access", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["identifiers", "flags", "access", ], str]):
