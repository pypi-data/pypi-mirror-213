...
class RecordingMinimalWithMusicalFeaturesDTO(
        ...
        class properties:
            ...
            class musicalFeatures(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['MusicalFeaturesDTO']:
                        return MusicalFeaturesDTO
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['MusicalFeaturesDTO'], typing.List['MusicalFeaturesDTO']],
                ...
                def __getitem__(self, i: int) -> 'MusicalFeaturesDTO':
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["musicalFeatures"]) -> MetaOapg.properties.musicalFeatures: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["isrc", "musicalFeatures", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["musicalFeatures"]) -> typing.Union[MetaOapg.properties.musicalFeatures, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["isrc", "musicalFeatures", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        musicalFeatures: typing.Union[MetaOapg.properties.musicalFeatures, list, tuple, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
