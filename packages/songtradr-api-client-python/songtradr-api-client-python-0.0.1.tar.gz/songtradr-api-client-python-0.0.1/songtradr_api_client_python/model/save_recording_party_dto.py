...
class SaveRecordingPartyDTO(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class contributorType(
                ...
                def TRACK_ARTIST(cls):
                    return cls("trackArtist")
    ...
    contributorType: MetaOapg.properties.contributorType
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["fullName"]) -> MetaOapg.properties.fullName: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["contributorType"]) -> MetaOapg.properties.contributorType: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["fullName", "contributorType", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["contributorType"]) -> MetaOapg.properties.contributorType: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["fullName", "contributorType", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        contributorType: typing.Union[MetaOapg.properties.contributorType, str, ],
