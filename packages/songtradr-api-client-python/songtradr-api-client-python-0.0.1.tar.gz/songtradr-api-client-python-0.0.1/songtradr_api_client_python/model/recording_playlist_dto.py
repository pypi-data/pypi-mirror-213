...
class RecordingPlaylistDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["recording", "songtradrTrackGuid", "assignedById", "sequence", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["songtradrTrackGuid"]) -> typing.Union[MetaOapg.properties.songtradrTrackGuid, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["assignedById"]) -> typing.Union[MetaOapg.properties.assignedById, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["recording", "songtradrTrackGuid", "assignedById", "sequence", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        songtradrTrackGuid: typing.Union[MetaOapg.properties.songtradrTrackGuid, str, schemas.Unset] = schemas.unset,
        assignedById: typing.Union[MetaOapg.properties.assignedById, decimal.Decimal, int, schemas.Unset] = schemas.unset,
