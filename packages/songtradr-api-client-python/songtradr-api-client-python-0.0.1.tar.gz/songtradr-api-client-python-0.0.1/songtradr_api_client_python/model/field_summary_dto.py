...
class FieldSummaryDTO(
    ...
    fieldValue: MetaOapg.properties.fieldValue
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["fieldValue", "total", "fieldName", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["fieldValue"]) -> MetaOapg.properties.fieldValue: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["fieldValue", "total", "fieldName", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        fieldValue: typing.Union[MetaOapg.properties.fieldValue, str, ],
