...
class ConfigAccessDTO(
    ...
    rights: MetaOapg.properties.rights
    accessorId: MetaOapg.properties.accessorId
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["accessorId"]) -> MetaOapg.properties.accessorId: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["accessorId", "rights", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["accessorId"]) -> MetaOapg.properties.accessorId: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["rights"]) -> MetaOapg.properties.rights: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["accessorId", "rights", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        rights: typing.Union[MetaOapg.properties.rights, str, ],
        accessorId: typing.Union[MetaOapg.properties.accessorId, str, ],
