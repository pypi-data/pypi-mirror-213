...
class TagsSummaryDTO(
        ...
        class properties:
            ...
            class categories(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['CategoryMinimalDTO']:
                        return CategoryMinimalDTO
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['CategoryMinimalDTO'], typing.List['CategoryMinimalDTO']],
                ...
                def __getitem__(self, i: int) -> 'CategoryMinimalDTO':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "total", "categories", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "total", "categories", ], str]):
