...
class RecordingGenrePredictionDTO(
    ...
    class MetaOapg:
        ...
        class properties:
            genreType = schemas.StrSchema
        
            @staticmethod
            def genre() -> typing.Type['GenreMinimalDTO']:
                return GenreMinimalDTO
            probability = schemas.Float32Schema
            __annotations__ = {
                "genreType": genreType,
                "genre": genre,
    ...
    genreType: MetaOapg.properties.genreType
    probability: MetaOapg.properties.probability
    genre: 'GenreMinimalDTO'
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["genreType"]) -> MetaOapg.properties.genreType: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["genre"]) -> 'GenreMinimalDTO': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["genreType", "genre", "probability", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["genreType"]) -> MetaOapg.properties.genreType: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["genre"]) -> 'GenreMinimalDTO': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["genreType", "genre", "probability", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        genreType: typing.Union[MetaOapg.properties.genreType, str, ],
        probability: typing.Union[MetaOapg.properties.probability, decimal.Decimal, int, float, ],
        genre: 'GenreMinimalDTO',
