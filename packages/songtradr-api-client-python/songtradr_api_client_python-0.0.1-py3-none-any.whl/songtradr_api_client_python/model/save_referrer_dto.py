...
class SaveReferrerDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["username", "url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["username", "url", ], str]):
