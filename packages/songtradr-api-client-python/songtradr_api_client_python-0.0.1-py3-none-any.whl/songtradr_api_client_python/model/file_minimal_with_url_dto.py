...
class FileMinimalWithUrlDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["fileName", "url", "isrc", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["fileName", "url", "isrc", ], str]):
