...
class RecordingMinimalWithTaggramsDTO(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class taggrams(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['TaggramDTO']:
                        return TaggramDTO
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['TaggramDTO'], typing.List['TaggramDTO']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'taggrams':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'TaggramDTO':
                    return super().__getitem__(i)
            __annotations__ = {
                "isrc": isrc,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["taggrams"]) -> MetaOapg.properties.taggrams: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["isrc", "timestamps", "taggrams", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["taggrams"]) -> typing.Union[MetaOapg.properties.taggrams, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["isrc", "timestamps", "taggrams", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        taggrams: typing.Union[MetaOapg.properties.taggrams, list, tuple, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
