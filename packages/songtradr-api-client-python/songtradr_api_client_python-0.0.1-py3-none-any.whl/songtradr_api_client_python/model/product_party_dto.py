...
class ProductPartyDTO(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def party() -> typing.Type['PartySmallDTO']:
            ...
            class contributorTypes(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ContributorTypeDTO']:
                        return ContributorTypeDTO
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ContributorTypeDTO'], typing.List['ContributorTypeDTO']],
                ...
                def __getitem__(self, i: int) -> 'ContributorTypeDTO':
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["party"]) -> 'PartySmallDTO': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["contributorTypes"]) -> MetaOapg.properties.contributorTypes: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["party", "contributorTypes", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["party"]) -> 'PartySmallDTO': ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["contributorTypes"]) -> typing.Union[MetaOapg.properties.contributorTypes, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["party", "contributorTypes", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        party: 'PartySmallDTO',
        contributorTypes: typing.Union[MetaOapg.properties.contributorTypes, list, tuple, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
