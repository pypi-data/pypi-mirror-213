...
# body param
SchemaForRequestBodyApplicationJson = SavePlaylistDTO


request_body_save_playlist_dto = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    @typing.overload
    def _create_or_update_playlist_oapg(
        self,
    ...
    def _create_or_update_playlist_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_save_playlist_dto.serialize(body, content_type)
...
class CreateOrUpdatePlaylist(BaseApi):
    ...
    def create_or_update_playlist(
        ...
        return self._create_or_update_playlist_oapg(
            body=body,
