...
RequestRequiredQueryParams = typing_extensions.TypedDict(
    ...
    {
        'genreType': typing.Union[GenreTypeSchema, str, ],
    }
)
...
request_query_genre_type = api_client.QueryParameter(
    name="genreType",
    style=api_client.ParameterStyle.FORM,
    schema=GenreTypeSchema,
    required=True,
    explode=True,
)
