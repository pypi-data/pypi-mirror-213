...
BpmMinSchema = schemas.Int32Schema
BpmMaxSchema = schemas.Int32Schema
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['FileMinimalWithUrlDTO']:
            return FileMinimalWithUrlDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['FileMinimalWithUrlDTO'], typing.List['FileMinimalWithUrlDTO']],
        _configuration: typing.Optional[schemas.Configuration] = None,
    ...
    def __getitem__(self, i: int) -> 'FileMinimalWithUrlDTO':
        return super().__getitem__(i)
...
class UserFilesDownload(BaseApi):
    ...
    def user_files_download(
        ...
        return self._user_files_download_oapg(
