...
# body param
SchemaForRequestBodyApplicationJson = ForgotPasswordDTO


request_body_forgot_password_dto = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _forgot_password_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_forgot_password_dto.serialize(body, content_type)
