...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['RecordingLargeDTO']:
            return RecordingLargeDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['RecordingLargeDTO'], typing.List['RecordingLargeDTO']],
    ...
    def __getitem__(self, i: int) -> 'RecordingLargeDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _recordings_large_by_ids_oapg(
        self,
...
class RecordingsLargeByIds(BaseApi):
    ...
    def recordings_large_by_ids(
        ...
        return self._recordings_large_by_ids_oapg(
