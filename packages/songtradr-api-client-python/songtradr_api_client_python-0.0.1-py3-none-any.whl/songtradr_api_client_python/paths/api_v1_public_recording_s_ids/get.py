...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['RecordingSmallDTO']:
            return RecordingSmallDTO

    def __new__(
        cls,
        _arg: typing.Union[typing.Tuple['RecordingSmallDTO'], typing.List['RecordingSmallDTO']],
    ...
    def __getitem__(self, i: int) -> 'RecordingSmallDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _recordings_small_by_ids_oapg(
        self,
...
class RecordingsSmallByIds(BaseApi):
    ...
    def recordings_small_by_ids(
        ...
        return self._recordings_small_by_ids_oapg(
