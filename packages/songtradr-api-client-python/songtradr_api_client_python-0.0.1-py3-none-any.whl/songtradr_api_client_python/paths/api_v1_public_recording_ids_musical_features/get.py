...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        @staticmethod
        def items() -> typing.Type['RecordingMinimalWithMusicalFeaturesDTO']:
    ...
    def __getitem__(self, i: int) -> 'RecordingMinimalWithMusicalFeaturesDTO':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _recordings_by_ids_with_musical_features_oapg(
        self,
...
class RecordingsByIdsWithMusicalFeatures(BaseApi):
    ...
    def recordings_by_ids_with_musical_features(
        ...
        return self._recordings_by_ids_with_musical_features_oapg(
