...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'responseSize': typing.Union[ResponseSizeSchema, str, ],
    },
    total=False
)
...
request_query_response_size = api_client.QueryParameter(
    name="responseSize",
    style=api_client.ParameterStyle.FORM,
    schema=ResponseSizeSchema,
    explode=True,
)
SchemaFor200ResponseBodyApplicationJson = SearchFilterValuesDTO
...
class BaseApi(api_client.Api):
    @typing.overload
    def _allowed_musical_features_oapg(
        self,
...
class AllowedMusicalFeatures(BaseApi):
    ...
    def allowed_musical_features(
        ...
        return self._allowed_musical_features_oapg(
