...
# body param
SchemaForRequestBodyApplicationJson = FileUploadDTO


request_body_file_upload_dto = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = InitPutRecordingAudioDTO
...
class BaseApi(api_client.Api):
    @typing.overload
    def _initiate_user_file_upload_oapg(
        self,
    ...
    def _initiate_user_file_upload_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_file_upload_dto.serialize(body, content_type)
...
class InitiateUserFileUpload(BaseApi):
    ...
    def initiate_user_file_upload(
        ...
        return self._initiate_user_file_upload_oapg(
            body=body,
