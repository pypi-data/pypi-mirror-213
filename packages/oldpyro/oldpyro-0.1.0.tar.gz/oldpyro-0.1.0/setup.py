...
with open("oldpyro/__init__.py", encoding="utf-8") as f:
...
class Clean(Command):
    ...
    API = [
        "oldpyro/errors/exceptions", "oldpyro/raw/functions", "oldpyro/raw/types", "oldpyro/raw/base",
        "oldpyro/raw/all.py"
    ]
    DOCS = [
...
setup(
    name="oldpyro",
    version=version,
    description="Fork of Pyrogram v1",
