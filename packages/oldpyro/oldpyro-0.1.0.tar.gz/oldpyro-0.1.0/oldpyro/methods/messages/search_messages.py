...
class SearchMessages(Scaffold):
    ...
    async def search_messages(
        ...
        If you want to get the messages count only, see :meth:`~oldpyro.Client.search_messages_count`.
        ...
        Returns:
            ``Generator``: A generator yielding :obj:`~oldpyro.types.Message` objects.
