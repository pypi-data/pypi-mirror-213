...
from oldpyro.file_id import FileId, FileType, PHOTO_TYPES
...
class DownloadMedia(Scaffold):
    async def download_media(
        ...
        Parameters:
            message (:obj:`~oldpyro.types.Message` | ``str``):
        ...
        Returns:
            ...
            the download failed or was deliberately stopped with :meth:`~oldpyro.Client.stop_transmission`, None is
            returned.
