...
class SendAnimation(Scaffold):
    async def send_animation(
        ...
        Returns:
            :obj:`~oldpyro.types.Message` | ``None``: On success, the sent animation message is returned, otherwise,
            in case the upload is deliberately stopped with :meth:`~oldpyro.Client.stop_transmission`, None is
            returned.
