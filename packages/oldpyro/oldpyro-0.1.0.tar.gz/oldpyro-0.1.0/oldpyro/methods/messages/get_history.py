...
class GetHistory(Scaffold):
    async def get_history(
        ...
        For a more convenient way of getting a chat history see :meth:`~oldpyro.Client.iter_history`.
        ...
        Returns:
            List of :obj:`~oldpyro.types.Message` - On success, a list of the retrieved messages is returned.
