...
class SendMediaGroup(Scaffold):
    ...
    async def send_media_group(
        ...
        Parameters:
            ...
            media (List of :obj:`~oldpyro.types.InputMediaPhoto`, :obj:`~oldpyro.types.InputMediaVideo`, :obj:`~oldpyro.types.InputMediaAudio` and :obj:`~oldpyro.types.InputMediaDocument`):
        ...
        Returns:
            List of :obj:`~oldpyro.types.Message`: On success, a list of the sent messages is returned.

        Example:
            .. code-block:: python

                from oldpyro.types import InputMediaPhoto, InputMediaVideo
