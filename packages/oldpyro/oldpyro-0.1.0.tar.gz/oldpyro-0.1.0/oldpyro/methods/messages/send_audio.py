...
from oldpyro import StopTransmission
from oldpyro import raw
from oldpyro import types
from oldpyro import utils
from oldpyro.errors import FilePartMissing
from oldpyro.file_id import FileType
from oldpyro.scaffold import Scaffold
...
class SendAudio(Scaffold):
    async def send_audio(
        ...
        For sending voice messages, use the :meth:`~oldpyro.Client.send_voice` method instead.
        ...
        Returns:
            :obj:`~oldpyro.types.Message` | ``None``: On success, the sent audio message is returned, otherwise, in
            case the upload is deliberately stopped with :meth:`~oldpyro.Client.stop_transmission`, None is returned.
