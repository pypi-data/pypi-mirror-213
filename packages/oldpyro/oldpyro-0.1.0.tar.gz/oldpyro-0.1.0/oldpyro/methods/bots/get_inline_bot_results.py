...
from oldpyro.errors import UnknownError
...
class GetInlineBotResults(Scaffold):
    async def get_inline_bot_results(
        ...
        You can then send a result using :meth:`~oldpyro.Client.send_inline_bot_result`
        ...
        Returns:
            :obj:`BotResults <oldpyro.api.types.messages.BotResults>`: On Success.
