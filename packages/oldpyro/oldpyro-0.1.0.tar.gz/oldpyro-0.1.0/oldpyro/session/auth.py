...
from oldpyro.connection import Connection
from oldpyro.crypto import aes, rsa, prime
from oldpyro.errors import SecurityCheckMismatch
from oldpyro.raw.core import TLObject, Long, Int
...
class Auth:
    ...
    def __init__(self, client: "oldpyro.Client", dc_id: int, test_mode: bool):
        self.dc_id = dc_id
