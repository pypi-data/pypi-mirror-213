...
import oldpyro
from oldpyro import __version__, __license__
from oldpyro import raw
from oldpyro import utils
from oldpyro.crypto import aes
from oldpyro.errors import CDNFileHashMismatch
from oldpyro.errors import (
    SessionPasswordNeeded,
    VolumeLocNotFound, ChannelPrivate,
    AuthBytesInvalid, BadRequest
)
from oldpyro.handlers.handler import Handler
from oldpyro.methods import Methods
from oldpyro.session import Auth, Session
from oldpyro.storage import Storage, FileStorage, MemoryStorage
from oldpyro.types import User, TermsOfService
from oldpyro.utils import ainput
...
class Client(Methods, Scaffold):
    ...
    Parameters:
        session_name (``str``):
            ...
            :meth:`~oldpyro.Client.export_session_string` before stopping the client to get a session string you can
    ...
    def load_config(self):
        ...
        if self.api_id and self.api_hash:
            ...
            if parser.has_section("pyrogram"):
                ...
                raise AttributeError("No API Key found. More info: https://docs.oldpyro.org/intro/setup")
    ...
    async def get_file(
        ...
        try:
            ...
            if not isinstance(e, oldpyro.StopTransmission):
                log.error(e, exc_info=True)
