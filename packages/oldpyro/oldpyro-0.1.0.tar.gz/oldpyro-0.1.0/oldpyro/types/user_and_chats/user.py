...
class User(Object, Update):
    ...
    async def archive(self):
        """Bound method *archive* of :obj:`~oldpyro.types.User`.
    ...
    async def unarchive(self):
        """Bound method *unarchive* of :obj:`~oldpyro.types.User`.
    ...
    def block(self):
        """Bound method *block* of :obj:`~oldpyro.types.User`.
    ...
    def unblock(self):
        """Bound method *unblock* of :obj:`~oldpyro.types.User`.
    ...
    def get_common_chats(self):
        """Bound method *get_common_chats* of :obj:`~oldpyro.types.User`.
