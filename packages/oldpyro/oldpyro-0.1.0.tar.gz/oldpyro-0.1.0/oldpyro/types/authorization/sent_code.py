...
class SentCode(Object):
    ...
    Parameters:
        ...
        phone_code_hash (``str``):
            ...
            :meth:`~oldpyro.Client.sign_in` or :meth:`~oldpyro.Client.sign_up`).

        next_type (``str``):
            Type of the next code to be sent with :meth:`~oldpyro.Client.resend_code`.
        ...
        timeout (``int``):
            Delay in seconds before calling :meth:`~oldpyro.Client.resend_code`.
    """
