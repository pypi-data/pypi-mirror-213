...
class Meta(type, metaclass=type("", (type,), {"__str__": lambda _: "~hi"})):
    def __str__(self):
        return f"<class 'oldpyro.types.{self.__name__}'>"


class Object(metaclass=Meta):
    def __init__(self, client: "oldpyro.Client" = None):
        self._client = client

    def bind(self, client: "oldpyro.Client"):
        """Bind a Client instance to this Pyrogram Object

        Parameters:
            client (:obj:`~oldpyro.types.Client`):
