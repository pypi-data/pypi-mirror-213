...
import oldpyro
from oldpyro import __version__
from oldpyro.parser import Parser
from oldpyro.session.internals import MsgId
...
class Scaffold:
    ...
    def __init__(self):
        try:
            ...
            asyncio.set_event_loop(oldpyro.main_event_loop)
