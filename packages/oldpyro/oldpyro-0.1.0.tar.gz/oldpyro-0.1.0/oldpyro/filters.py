...
import oldpyro
from oldpyro.types import Message, CallbackQuery, InlineQuery, InlineKeyboardMarkup, ReplyKeyboardMarkup, Update


class Filter:
    async def __call__(self, client: "oldpyro.Client", update: Update):
...
def create(func: Callable, name: str = None, **kwargs) -> Filter:
    ...
    Parameters:
        func (``callable``):
            ...
            The *client* argument refers to the :obj:`~oldpyro.Client` that received the update.
            The *update* argument type will vary depending on which `Handler <handlers>`_ is coming from. 
            For example, in a :obj:`~oldpyro.handlers.MessageHandler` the *update* argument will be a :obj:`~oldpyro.types.Message`; in a :obj:`~oldpyro.handlers.CallbackQueryHandler` the *update* will be a :obj:`~oldpyro.types.CallbackQuery`.
        ...
        **kwargs (``any``, *optional*):
            ...
            :meth:`~oldpyro.filters.command` or :meth:`~oldpyro.filters.regex`.
    """
    return type(
...
"""Filter messages that contain :obj:`~oldpyro.types.Audio` objects."""
...
"""Filter messages that contain :obj:`~oldpyro.types.Document` objects."""
...
"""Filter messages that contain :obj:`~oldpyro.types.Photo` objects."""
...
"""Filter messages that contain :obj:`~oldpyro.types.Sticker` objects."""
...
"""Filter messages that contain :obj:`~oldpyro.types.Animation` objects."""
...
"""Filter messages that contain :obj:`~oldpyro.types.Game` objects."""
...
"""Filter messages that contain :obj:`~oldpyro.types.Video` objects."""
...
"""Filter messages that contain :obj:`~oldpyro.types.Voice` note objects."""
...
"""Filter messages that contain :obj:`~oldpyro.types.VideoNote` objects."""
...
"""Filter messages that contain :obj:`~oldpyro.types.Contact` objects."""
...
"""Filter messages that contain :obj:`~oldpyro.types.Location` objects."""
...
"""Filter messages that contain :obj:`~oldpyro.types.Venue` objects."""
...
"""Filter messages that contain :obj:`~oldpyro.types.Poll` objects."""
...
"""Filter messages that contain :obj:`~oldpyro.types.Dice` objects."""
...
def command(commands: Union[str, List[str]], prefixes: Union[str, List[str]] = "/", case_sensitive: bool = False):
    ...
    Parameters:
        commands (``str`` | ``list``):
            ...
            field of the :obj:`~oldpyro.types.Message`.
    ...
    async def func(flt, client: oldpyro.Client, message: Message):
...
def regex(pattern: Union[str, Pattern], flags: int = 0):
    ...
    - :obj:`~oldpyro.types.Message`: The filter will match ``text`` or ``caption``.
    - :obj:`~oldpyro.types.CallbackQuery`: The filter will match ``data``.
    - :obj:`~oldpyro.types.InlineQuery`: The filter will match ``query``.
