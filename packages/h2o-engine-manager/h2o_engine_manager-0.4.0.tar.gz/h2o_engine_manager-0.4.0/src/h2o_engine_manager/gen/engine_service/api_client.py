...
from h2o_engine_manager.gen.engine_service import rest
from h2o_engine_manager.gen.engine_service.configuration import Configuration
from h2o_engine_manager.gen.engine_service.exceptions import ApiTypeError, ApiValueError, ApiException
from h2o_engine_manager.gen.engine_service.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = EngineServiceApi()
        api_instance.engine_service_list_engines  # this is an instance of the class Endpoint
        api_instance.engine_service_list_engines()  # this invokes api_instance.engine_service_list_engines.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.engine_service_list_engines.callable or self.callable in this class
