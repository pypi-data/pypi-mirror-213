...
from h2o_engine_manager.gen.dai_version_service.api_client import ApiClient, Endpoint as _Endpoint
from h2o_engine_manager.gen.dai_version_service.model_utils import (  # noqa: F401
...
class DAIVersionServiceApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.d_ai_version_service_list_dai_versions_endpoint = _Endpoint(
            settings={
                'response_type': (V1ListDAIVersionsResponse,),
                'auth': [],
                'endpoint_path': '/v1/daiVersions',
                'operation_id': 'd_ai_version_service_list_dai_versions',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def d_ai_version_service_list_dai_versions(
        self,
        **kwargs
    ):
        ...
        >>> thread = api.d_ai_version_service_list_dai_versions(async_req=True)
        >>> result = thread.get()
        ...
        return self.d_ai_version_service_list_dai_versions_endpoint.call_with_http_info(**kwargs)
