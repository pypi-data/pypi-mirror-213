...
class LatentClassModel(MultinomialLogit):
    ...
    def fit(self, X, y, varnames=None, alts=None, isvars=None, num_classes=2,
        ...
        # if init_class_betas is not None:
        #     init_class_betas = dev.np.array(init_class_betas)
        self.init_class_betas = init_class_betas

        # if init_class_thetas is not None:
        #     init_class_thetas = dev.np.array(init_class_thetas)
