...
import graphscope.proto.op_def_pb2
...
class ConnectSessionResponse(google.protobuf.message.Message):
    ...
    """
    cluster_type: graphscope.proto.types_pb2.ClusterType.ValueType
...
class RunStepRequestHead(google.protobuf.message.Message):
    ...
    """
    @property
    def dag_def(self) -> graphscope.proto.op_def_pb2.DagDef:
        """REQUIRED: A Dag with op that will be evaluated."""
    def __init__(
        self,
        *,
        session_id: builtins.str = ...,
        dag_def: graphscope.proto.op_def_pb2.DagDef | None = ...,
    ) -> None: ...
...
class RunStepResponseHead(google.protobuf.message.Message):
    ...
    @property
    def results(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[graphscope.proto.op_def_pb2.OpResult]:
    ...
    def __init__(
        self,
        *,
        results: collections.abc.Iterable[graphscope.proto.op_def_pb2.OpResult] | None = ...,
        code: graphscope.proto.error_codes_pb2.Code.ValueType = ...,
        error_msg: builtins.str = ...,
        full_exception: builtins.bytes = ...,
    ) -> None: ...
...
class CreateInteractiveInstanceRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["object_id", b"object_id", "schema_path", b"schema_path", "session_id", b"session_id"]) -> None: ...
...
class CreateInteractiveInstanceResponse(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["gremlin_endpoint", b"gremlin_endpoint", "object_id", b"object_id"]) -> None: ...
...
class CreateLearningInstanceRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing_extensions.Literal["config", b"config", "handle", b"handle", "object_id", b"object_id", "session_id", b"session_id"]) -> None: ...
