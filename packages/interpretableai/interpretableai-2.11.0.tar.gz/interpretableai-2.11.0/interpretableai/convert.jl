module IAIConvert
  ...
  function convert_to_jl_set(o::PyObject)
    Set(collect(o))
  end
  ...
  function convert_to_py(o::AbstractDict)
    OrderedDict(k => convert_to_py(v) for (k, v) in o)
  end
...
if isdefined(IAI, :IAILicensing) &&
   isdefined(IAI.IAILicensing, :acquire_license_all_procs)
  @eval IAI begin
    function acquire_license_all_procs_convert(args...; kwargs...)
      IAILicensing.acquire_license_all_procs(args...; kwargs...)
    end
  end
end
