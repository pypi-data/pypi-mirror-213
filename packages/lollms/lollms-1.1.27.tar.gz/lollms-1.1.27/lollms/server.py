...
from lollms import AIPersonality, MSG_TYPE, lollms_path
...
class LoLLMsServer:
    ...
    def run(self, host="localhost", port="9600"):
        ...
        parser.add_argument('--bindings_path', '-bp', default=str(lollms_path / "bindings_zoo"),
                            help='The path to the Bindings folder')
        parser.add_argument('--personalities_path', '-pp',
                            default=str(lollms_path / "personalities_zoo"),
                            help='The path to the personalities folder')
        parser.add_argument('--models_path', '-mp', default=str(lollms_path / "models"),
