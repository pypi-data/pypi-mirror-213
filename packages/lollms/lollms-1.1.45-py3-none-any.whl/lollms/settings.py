...
def main():
    ...
    if args.reset_config:
        ...
        try:
            cfg_path.unlink()
            ASCIIColors.print(ASCIIColors.color_green,"LOLLMS configuration reset successfully")
        except:
            ASCIIColors.print(ASCIIColors.color_green,"Couldn't reset LOLLMS configuration")
