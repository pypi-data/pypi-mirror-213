...
from lollms.paths import lollms_personal_path, lollms_personal_configuration_path
...
class Processor(APScript):
    ...
    def __init__(self, personality: AIPersonality) -> None:
        ...
        self.config = self.load_config_file(lollms_personal_configuration_path/"personality_ask_internet.yaml")
    ...
    def internet_search(self, query):
        ...
        """
        formatted_text = ""
        results = extract_results(f"https://duckduckgo.com/?q={format_url_parameter(query)}&t=h_&ia=web", self.config["num_results"], self.config["chromedriver_path"])
