...
class MainMenu:
    ...
    def reinstall_personality(self):
        ...
        try:
            ...
            ASCIIColors.error(f"Couldn't load personality. Please verify your configuration file at {conversation.cfg_path} or use the next menu to select a valid personality")
