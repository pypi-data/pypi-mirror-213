...
class AIPersonality:
    ...
    def __init__(self, personality_package_path: str|Path = None, model:LLMBinding=None, run_scripts=True, is_relative_path=True):
        """
...
"""
        ...
        if personality_package_path is None:
            ...
            if is_relative_path:
                self.personality_package_path = self.model.config.lollms_paths.personalities_zoo_path/personality_package_path
            else:
    ...
    def set_model(self, model:LLMBinding):
        self.model = model
