...
def plotBipartiteGraph(filename, pathToFolder, ax=None , connected = False):
    """
...
def plotUnipartiteGraph(filename, pathToFolder, ax = None, connected=False):
    """
...
def communityVisualization(filename, pathToFolder,ax= None, withLabels = False, font_size = 8, edgewidth = 0.1, colorList =  ["orange", "yellow", "white"]):
    """
    Desc
    ----
