...
def get_prompts(
    ...
    for i, prompt in enumerate(prompts):
        if langplus.llm_cache is not None:
            cache_val = langplus.llm_cache.lookup(prompt, llm_string)
...
def update_cache(
    ...
    for i, result in enumerate(new_results.generations):
        ...
        if langplus.llm_cache is not None:
            langplus.llm_cache.update(prompt, llm_string, result)
...
class BaseLLM(BaseLanguageModel, ABC):
    ...
    def generate(
        ...
        if langplus.llm_cache is None or disregard_cache:
