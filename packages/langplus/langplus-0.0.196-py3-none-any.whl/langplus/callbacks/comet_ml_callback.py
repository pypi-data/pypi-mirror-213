...
from langplus.callbacks.utils import (
...
from langplus.schema import AgentAction, AgentFinish, Generation, LLMResult
...
class CometCallbackHandler(BaseMetadataCallbackHandler, BaseCallbackHandler):
    ...
    def _log_session(self, langchain_asset: Optional[Any] = None) -> None:
        ...
        try:
            metadata = {"langchain_version": str(langplus.__version__)}
