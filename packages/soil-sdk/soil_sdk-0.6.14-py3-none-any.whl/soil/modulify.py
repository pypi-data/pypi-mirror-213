...
from typing import Any, Callable, cast, get_args, TypeVar
import warnings
...
def _omittable_parentheses(
    maybe_decorator: Callable[..., _IterableGenericDataStructure] | None = None,
    /,
    allow_partial: bool = False,
) -> Callable[..., _IterableGenericDataStructure]:
...
@decorator(depth=2)
def modulify(
    _func: Callable[..., _IterableGenericDataStructure] | None = None,
    *,
    ...
    def modulify_decorator(
        fn: Callable[..., _IterableGenericDataStructure]
    ) -> Callable:
        ...
        def decorated(
            *inputs: DataStructure, **kwargs: Any
            ...
            if (
                ...
                and num_outputs.__origin__ == tuple
            ):
