...
class AffiliationScheme(ModelSimple):
    ...
    allowed_values = {
        ('value',): {
            ...
            'ACADEMIC-PLAN.V1.STUDENT-RECORDS.UNIVERSITY.IDENTIFIERS.CAM.AC.UK': "academic-plan.v1.student-records.university.identifiers.cam.ac.uk",
        },
    }
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): An enumeration.., must be one of ["institution.v1.student-records.university.identifiers.cam.ac.uk", "academic-plan.v1.student-records.university.identifiers.cam.ac.uk", ]  # noqa: E501

        Keyword Args:
            value (str): An enumeration.., must be one of ["institution.v1.student-records.university.identifiers.cam.ac.uk", "academic-plan.v1.student-records.university.identifiers.cam.ac.uk", ]  # noqa: E501
