...
class PaginatedResultsStudent(ModelNormal):
    ...
    def _from_openapi_data(cls, results, *args, **kwargs):  # noqa: E501
        """PaginatedResultsStudent - a model defined in OpenAPI

        Args:
            results ([Student]): A list of the current page of results.
        ...
        Keyword Args:
            ...
            next (str, none_type): The url to use to retrieve the next page of results.. [optional]  # noqa: E501
            previous (str, none_type): The url to use to retrieve the previous page of results.. [optional]  # noqa: E501
        """
