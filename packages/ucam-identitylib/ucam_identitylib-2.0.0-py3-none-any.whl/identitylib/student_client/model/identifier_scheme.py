...
class IdentifierScheme(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): An enumeration.. if omitted defaults to "person.v1.student-records.university.identifiers.cam.ac.uk", must be one of ["person.v1.student-records.university.identifiers.cam.ac.uk", ]  # noqa: E501

        Keyword Args:
            value (str): An enumeration.. if omitted defaults to "person.v1.student-records.university.identifiers.cam.ac.uk", must be one of ["person.v1.student-records.university.identifiers.cam.ac.uk", ]  # noqa: E501
        ...
        if 'value' in kwargs:
            ...
            value = "person.v1.student-records.university.identifiers.cam.ac.uk"
