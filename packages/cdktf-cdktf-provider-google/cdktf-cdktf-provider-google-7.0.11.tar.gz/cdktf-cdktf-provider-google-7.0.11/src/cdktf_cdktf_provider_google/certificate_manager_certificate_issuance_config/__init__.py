...
class CertificateManagerCertificateIssuanceConfig(
    ...
    def timeouts_input(
        self,
    ) -> typing.Optional[typing.Union["CertificateManagerCertificateIssuanceConfigTimeouts", _cdktf_9a9027ec.IResolvable]]:
        return typing.cast(typing.Optional[typing.Union["CertificateManagerCertificateIssuanceConfigTimeouts", _cdktf_9a9027ec.IResolvable]], jsii.get(self, "timeoutsInput"))
...
class CertificateManagerCertificateIssuanceConfigTimeoutsOutputReference(
    ...
    def internal_value(
        ...
        return typing.cast(typing.Optional[typing.Union[CertificateManagerCertificateIssuanceConfigTimeouts, _cdktf_9a9027ec.IResolvable]], jsii.get(self, "internalValue"))

    @internal_value.setter
    def internal_value(
        self,
        value: typing.Optional[typing.Union[CertificateManagerCertificateIssuanceConfigTimeouts, _cdktf_9a9027ec.IResolvable]],
    ) -> None:
        if __debug__:
