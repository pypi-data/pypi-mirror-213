...
class CustomNestedDeviceSerializer(WritableNestedSerializer):
    ...
    class Meta:
        model = Device
        fields = ["id", "url", "display", "name", "serial", "device_type"]
...
class CiscoDeviceSupportSerializer(NetBoxModelSerializer):
    ...
    device = CustomNestedDeviceSerializer()

    class Meta:
        model = CiscoDeviceSupport
        # fmt: off
        fields = [
            "id", "url", "display", "device", "device_type", "api_status", "sr_no_owner", "is_covered",
            ...
            "end_of_security_vul_support_date", "end_of_security_vul_support_date",
