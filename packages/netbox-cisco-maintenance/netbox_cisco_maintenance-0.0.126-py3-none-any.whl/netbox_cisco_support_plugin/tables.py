...
class CiscoSupportTable(NetBoxTable):
    ...
    class BooleanColumn(tables.Column):
        ...
        def render(self, value):
            if value:
                rendered = '<span class="text-success"><i class="mdi mdi-check-circle text-success"></i></span>'
            elif value is None:
                rendered = '<span class="text-muted">&mdash;</span>'
            else:
                rendered = '<span class="text-danger"><i class="mdi mdi-check-circle text-danger"></i></span>'
