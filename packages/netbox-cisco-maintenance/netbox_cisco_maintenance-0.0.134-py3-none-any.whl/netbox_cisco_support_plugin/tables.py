...
class CiscoSupportTable(NetBoxTable):
    def get_default_actions(self):
        default_actions = super().get_default_actions()
        # Remove the "edit" action from the default_actions list
        default_actions.remove("edit")
        default_actions.remove("changelog")
