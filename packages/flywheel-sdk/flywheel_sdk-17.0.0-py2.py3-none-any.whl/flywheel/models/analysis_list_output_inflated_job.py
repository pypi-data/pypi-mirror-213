...
from flywheel.models.job_list_output import JobListOutput  # noqa: F401,E501
...
class AnalysisListOutputInflatedJob(object):
    ...
    def __init__(self, id=None, label=None, parent=None, parents=None, created=None, modified=None, revision=None, inputs=None, description=None, tags=None, files=None, notes=None, job_id=None, job=None, gear_info=None, compute_provider_id=None, join_origin=None, copy_of=None, original_copy_of=None):  # noqa: E501
        """AnalysisListOutputInflatedJob - a model defined in Swagger"""
        super(AnalysisListOutputInflatedJob, self).__init__()
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, relatives + (AnalysisListOutputInflatedJob,)):
            return False
