...
from flywheel.models.join_origin_device import JoinOriginDevice  # noqa: F401,E501
from flywheel.models.join_origin_job import JoinOriginJob  # noqa: F401,E501
from flywheel.models.join_origin_user import JoinOriginUser  # noqa: F401,E501
...
class JoinOrigins(object):
    ...
    swagger_types = {
        'device': 'dict(str, JoinOriginDevice)',
        'job': 'dict(str, JoinOriginJob)',
        'user': 'dict(str, JoinOriginUser)'
    }
    ...
    def __init__(self, device=None, job=None, user=None):  # noqa: E501
        ...
        super(JoinOrigins, self).__init__()
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, JoinOrigins):
            return False
