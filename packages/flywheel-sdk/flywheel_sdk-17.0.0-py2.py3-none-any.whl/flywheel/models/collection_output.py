...
class CollectionOutput(CollectionMixin):
    ...
    def __init__(self, created=None, modified=None, label=None, description=None, info=None, id=None, curator=None, revision=1, notes=None, tags=None, analyses=None, permissions=None, join_origin=None, files=None, attachment_count=0, session_count=0, noncompliant_session_count=0, subject_count=0):  # noqa: E501
        """CollectionOutput - a model defined in Swagger"""
        super(CollectionOutput, self).__init__()
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, relatives + (CollectionOutput,)):
            return False
