...
class SubjectInput(object):
    ...
    def __init__(self, firstname=None, lastname=None, sex=None, cohort=None, date_of_birth=None, mlset=None, type=None, race=None, ethnicity=None, species=None, strain=None, label=None, code=None, master_code=None, tags=None, info=None, state=None, project=None):  # noqa: E501
        """SubjectInput - a model defined in Swagger"""
        super(SubjectInput, self).__init__()
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SubjectInput):
            return False
