...
class DataViewExecution(object):
    ...
    def __init__(self, id=None, created=None, modified=None, timestamp_ran=None, user_id=None, project_id=None, state=None, data_view_id=None, storage_file_id=None, task_id=None, expires_on=None, revision=None):  # noqa: E501
