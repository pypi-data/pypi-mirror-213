...
from flywheel.models.project_share_level import ProjectShareLevel  # noqa: F401,E501
...
class ProjectSettingsSharing(object):

    swagger_types = {
        'share_level': 'ProjectShareLevel',
    ...
    def __init__(self, share_level=None, project_institutions=None, project_contacts=None, summary=None, therapeutic_areas=None, body_regions=None, organ_systems=None):  # noqa: E501
        ...
        super(ProjectSettingsSharing, self).__init__()
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProjectSettingsSharing):
            return False
