...
class Provider(object):
    ...
    def __init__(self, id=None, provider_class=None, provider_type=None, access_type=None, label=None, origin=None, created=None, modified=None, config=None, creds=None):  # noqa: E501
