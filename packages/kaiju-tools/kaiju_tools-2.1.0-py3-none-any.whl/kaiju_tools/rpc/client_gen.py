...
class RPCClientCodeGenerator(Service):
    ...
    def generate_source_file(
        ...
        module_name: str = 'kaiju_tools.http.client',
        class_name: str = 'RPCClientService',
    ) -> None:
        ...
        code = template.render(
            app_name=app_name, service_doc=service_doc, methods=methods, module_name=module_name, class_name=class_name
        )
