...
class AnnotationParser:
    ...
    @classmethod
    def parse_method(cls, service_cls: Type[AbstractRPCCompatible], route: str, method, /) -> FunctionAnnotation:
    ...
    def parse_function_annotations(
        cls, service_cls: Type[AbstractRPCCompatible], f: Callable
...
class EnumTypeParser(TypeParser):
    ...
    def parse_annotation(cls, annotation: Type[enum.Enum]) -> j.JSONSchemaObject:
        ...
        return j.JSONSchemaObject(
            description=annotation.__doc__, enum=[v.value for k, v in annotation._member_map_.items()], title=title
        )  # noqa
