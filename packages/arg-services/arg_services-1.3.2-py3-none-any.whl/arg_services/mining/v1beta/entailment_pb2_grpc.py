...
def add_EntailmentServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'arg_services.mining.v1beta.EntailmentService', rpc_method_handlers)
...
class EntailmentService(object):
    ...
    def Entailments(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/arg_services.mining.v1beta.EntailmentService/Entailments',
            arg__services_dot_mining_dot_v1beta_dot_entailment__pb2.EntailmentsRequest.SerializeToString,
            arg__services_dot_mining_dot_v1beta_dot_entailment__pb2.EntailmentsResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
