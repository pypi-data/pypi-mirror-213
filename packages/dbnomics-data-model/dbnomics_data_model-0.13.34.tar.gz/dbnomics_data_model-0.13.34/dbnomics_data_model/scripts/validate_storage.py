...
def main(
    ...
    ignored_errors_log: Optional[Path] = typer.Option(None, help="Output log file for ignored errors"),
    ...
    validation_yml: Optional[Path] = typer.Option(None, help=f"Path to the {VALIDATION_YML} settings file"),
