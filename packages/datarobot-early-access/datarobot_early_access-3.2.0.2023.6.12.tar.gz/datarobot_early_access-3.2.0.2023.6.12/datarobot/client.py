...
from .context import Context, DefaultUseCase, ENABLE_API_CONSUMER_TRACKING_DEFAULT
...
def _create_client(
    ...
    enable_api_consumer_tracking: Optional[bool] = ENABLE_API_CONSUMER_TRACKING_DEFAULT,
    ...
    return client, drconfig.default_use_case, enable_api_consumer_tracking, trace_context
...
def _config_from_env() -> DataRobotClientConfig:
    ...
    enable_api_consumer_tracking: bool = bool(
        os.environ.get(
