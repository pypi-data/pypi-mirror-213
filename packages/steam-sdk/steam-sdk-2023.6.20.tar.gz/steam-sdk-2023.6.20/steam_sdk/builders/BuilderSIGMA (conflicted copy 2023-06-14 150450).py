        ...
        if flag_build:
            ...
            for cond in model_data.Conductors:
                ...
                try:
                    ...
                    conductor.cable.n_strands_per_layers = 1

                try:
                    conductor.cable.n_strand_layers = cond.cable.n_strand_layers
                except:
                    conductor.cable.n_strand_layers = int(conductor.cable.n_strands/conductor.cable.n_strands_per_layers)
                ...
                try: conductor.strand.diameter = cond.strand.diameter
                    ...
                    print("WANING! Diameter not present for this coil. Calculating equivalent diameter using bare_width and bare_height")
