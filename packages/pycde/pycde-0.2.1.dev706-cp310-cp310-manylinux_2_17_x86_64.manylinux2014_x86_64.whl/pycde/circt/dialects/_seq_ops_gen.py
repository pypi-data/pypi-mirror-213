...
class ClockGateOp(_ods_ir.OpView):
  ...
  def __init__(self, output, input, enable, *, test_enable=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class CompRegClockEnabledOp(_ods_ir.OpView):
  ...
  def __init__(self, data, input, clk, clockEnable, name, *, reset=None, resetValue=None, sym_name=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
